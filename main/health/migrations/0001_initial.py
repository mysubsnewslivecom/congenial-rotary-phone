    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name of the rule', max_length=300, verbose_name='Rule Name')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rule_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rules', to='health.rule', verbose_name='rule id')),
            ],
            options={
